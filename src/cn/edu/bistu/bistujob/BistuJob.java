...
public class BistuJob extends FragmentActivity implements ActionBar.TabListener {
	...
	private List<ItemWithOutDrawable> items;
		...
		client.get("http://m.bistu.edu.cn/newapi/jobtype.php",
				new AsyncHttpResponseHandler() {
					...
					public void onFailure(int arg0, Header[] arg1, byte[] arg2,
							Throwable arg3) {
						// TODO Auto-generated method stub
						Toast.makeText(BistuJob.this, "加载失败！",
					...
					public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
						...
						jobTypes = (ArrayList<JobType>) (new JsonJobType()).getJobTypes(information);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		/*
		 * try { MenuItem search = menu.findItem(R.id.search); SearchView
		 ...
		 * Auto-generated method stub Toast.makeText(BistuJob.this, query,
		 * Toast.LENGTH_SHORT).show(); return true; }
		 * 
		 * @Override public boolean onQueryTextChange(String newText) { // TODO
		 * Auto-generated method stub return false; } }); } catch (Exception e)
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.fenlei:
			showPopWindow();
			break;
		case R.id.bistu_job_more:
			items = new ArrayList<ItemWithOutDrawable>();
			items.add(new ItemWithOutDrawable("发布", JobPublish.class));
			items.add(new ItemWithOutDrawable("我的收藏", MySave.class));
			items.add(new ItemWithOutDrawable("我的发布", MyPublish.class));
			JobMoreAdapter moreAdapter = new JobMoreAdapter(BistuJob.this,
					items);
			final MyPopWindow popWindow = new MyPopWindow(BistuJob.this);
			popWindow.showPopWindow(R.layout.sort, R.id.sort, moreAdapter,
					new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> arg0, View arg1,
								int arg2, long arg3) {
							// TODO Auto-generated method stub
							if (items.get(arg2).getText().equals("发布")) {
								intent.putExtra("type", jobTypes);
								intent.setClass(BistuJob.this, items.get(arg2).getCls());
								startActivity(intent);
								popWindow.dismiss();
							} else {
								intent.setClass(BistuJob.this, items.get(arg2)
										.getCls());
								startActivity(intent);
								popWindow.dismiss();
							}
						}
					}, screenWidth / 2 + 10, findViewById(R.id.fenlei), -100);
			break;
	...
	public void showPopWindow() {
		...
		popupWindow.showAsDropDown(findViewById(R.id.fenlei), -100, 0);
	}
