...
public class JobDetail extends Activity {
		...
		client.get("http://m.bistu.edu.cn/newapi/jobdetail.php?id=" + id,
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
						...
						detail = (new JsonJobDetail()).getList(infor);
						try {
							setdata(detail);
						} catch (Exception e) {
							// TODO: handle exception
	...
	private void init() {
		...
		// detailpublishcompany = (TextView)
		// findViewById(R.id.detailpublishcompany);
		// detailworklocation = (TextView)
		// findViewById(R.id.detailworklocation);
		detaildescription = (TextView) findViewById(R.id.detaildescription);
		// detailqualification = (TextView)
		// findViewById(R.id.detailqualification);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			...
			break;
		case R.id.save:
			OperateFileForMySaveJob saveJob = new OperateFileForMySaveJob(
					JobDetail.this);
			try {
				saveJob.saveJob(id, detail);
				Toast.makeText(JobDetail.this, "收藏成功！", Toast.LENGTH_LONG)
						.show();
			} catch (IOException e) {
				// TODO Auto-generated catch block
				Toast.makeText(JobDetail.this, "收藏失败！", Toast.LENGTH_LONG)
						.show();
				e.printStackTrace();
			}
			break;
